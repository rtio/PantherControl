...
<meta charset="utf-8">
    ...
    <script src="http://maps.google.com/maps?file=api&v=2.x&key=AIzaSyA0jBXruRcs6o8EmAWl6Xh_uyfHK1Gd51A" type="text/javascript"></script>

    <script type="text/javascript" src="../static/js/ajax.js"></script>

    <script type="text/javascript" src="../static/js/distancia.js"></script>

    <form name="formTrajeto" id="formTrajeto"class="form-horizontal" method="post" action="#">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="radio">
                    <label>
                        <input type="radio" name="ponto1" id="ponto1" required value="<?php echo utf8_encode($usuario['endereco']) . ", " . utf8_encode($usuario['bairro']) . ", " . $usuario['cidade'] . ", " . $usuario['estado']; ?>">
                        Casa
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <img id="loading" src="../static/img/loading.gif" style="display: none; position: relative;" align="center"></img>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="radio">
                    <label>
                        <input type="radio" name="ponto3" id="ponto3" required value="<?php echo utf8_encode($usuario['endereco']) . ", " . utf8_encode($usuario['bairro']) . ", " . $usuario['cidade'] . ", " . $usuario['estado']; ?>">
                        Casa
        ...
        <input type="hidden" name="diferenca" id="diferenca">

        <button type="submit" onclick="postRota();" class="btn btn-primary btn-lg btn-block">
