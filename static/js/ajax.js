...
$.ajax({
  type: "GET",
  url: "../control/ConsultaEscola.php?pesquisa=" + pesquisa,
}).done(function(result) {
 $('#ponto2').val(result);
});
$.ajax({
  type: "GET",
  url: "../control/ConsultaEscola2.php?pesquisa=" + pesquisa,
}).done(function(result2) {
 $('#ponto2persist').val(result2);
});
}
...
$.post( "../model/postRota.php", $( "#formTrajeto" ).serialize())
  .done(alert('Rota cadastrada com sucesso!'))
  .fail()
}